...
struct Constants {
    ...
    struct URL {
       ...
       //https://w9x3sqbas6.execute-api.eu-west-1.amazonaws.com/api/ine/consulta-residencia-fecha?tipoDocumento=DNI&identificador=99999999R&nombre=JUAN&apellido1=MENDILUCE&apellido2=MENDILUCE
